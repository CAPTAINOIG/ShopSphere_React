      ...
      <div className="content bg-white mx-10 p-8 rounded-lg shadow-md w-full max-w-sm">
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="">
            ...
            <input
              type="otp"
              className="h-[50px] w-full p-3 border border-gray-300 my-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
          ...
          <button
            type="submit"
            className="btn btn-block w-full bg-pink-500 text-white py-3 my-3 rounded-md hover:bg-gray-200 hover:text-pink-500"
          >
            {loading ? (
              <img src={gif} alt="" className="w-[25px] text-center mx-auto" />
            ) : (
              "Log in"
            )}
          </button>
