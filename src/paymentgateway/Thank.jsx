        ...
        <div className='lg:w-[175%]  w-[140%] h-screen'>
         <section className='flex flex-col justify-center items-center h-full mt-[-40px] md:mx-40 mx-20'>
          <div className='text-center text-[15px] font-bold'>
            ...
            <div className='text-center my-5'>
                <button type='submit' className='bg-pink-500  text-white border py-1 px-5 rounded hover:bg-white font-bold hover:text-pink-500  border-pink-500 '>Go To Previous</button>
            </div>
        </section>
        </div>
